                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="key-feature d-flex p-3 rounded shadow bg-white">
                            ...
                            <div class="content mt-2">
                                <h4 class="title mb-0">Cross Browser Compatibility</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="key-feature d-flex p-3 rounded shadow bg-white">
                            ...
                            <div class="content mt-2">
                                <h4 class="title mb-0">Visible Processes</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="key-feature d-flex p-3 rounded shadow bg-white">
                            ...
                            <div class="content mt-2">
                                <h4 class="title mb-0">End to End Development</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="key-feature d-flex p-3 rounded shadow bg-white">
                            ...
                            <div class="content mt-2">
                                <h4 class="title mb-0">Secure & Compliant</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="key-feature d-flex p-3 rounded shadow bg-white">
                            ...
                            <div class="content mt-2">
                                <h4 class="title mb-0">Bespoke Solutions</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="key-feature d-flex p-3 rounded shadow bg-white">
                            ...
                            <div class="content mt-2">
                                <h4 class="title mb-0">OTA Code Updates</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
