<!DOCTYPE php>
    <php lang="en">
        ...
        <body>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                                    <div class="position-relative">
                                        <img src="images/illustrator/Startup_SVG.svg" class="rounded img-fluid mx-auto d-block" alt="">
                                        
                                        <!--WHEN VIDEO READY, ADD HERE
                                        <div class="play-icon">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 text-center">
                            <div class="section-title mb-4 pb-2">
                                <h4 class="title mb-4">What is flexBot</h4>
                                <p class="text-muted para-desc mx-auto mb-0"><span class="text-primary font-weight-bold">FlexBot</span> is a Robotic Process Automation centered company.</p>
                                <p class="text-muted para-desc mx-auto mb-0">We build, manage, service, & consult on organizational automation infastructures.</p>
                                <p class="text-muted para-desc mx-auto mb-0">Start working with <span class="text-primary font-weight-bold">FlexBot</span> and see the rise in efficiency and fall in your bottom line.</p>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
            ...
            <!-- VIDEO Start -->
            <section class="bg-cta" data-jarallax='{"speed": 0.5}' style="background: url('images/building digital robots.png');" id="cta">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12 text-center">
