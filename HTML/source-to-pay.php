                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12 text-center">
                                <div class="page-next-level">
                                    <h4 class="title"> SOURCE TO PAY RFP (S2P) AUTOMATION </h4>
                                    ...
                                    <ul class="page-next d-inline-block bg-white shadow p-2 pl-4 pr-4 rounded mb-0">
                                        ...
                                        <li>
                                            <span class="text-uppercase text-primary font-weight-bold"> Source to Pay Automation </span> 
                                        </li> 
                                    </ul>
                                </div>
                            </div>  <!--end col-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <div class="p-4 shadow rounded border">
                            <h5>Overview :</h5>
                            <h6>Business Automation + Digital Robots + RFP Automation </h6>
                            <p class="text-muted">This process automates the creation of purchase requisition (PR) in SmartBuy Ariba for each newly awarded Request for Proposal (RFP) in CVENT. The robot picks details of each awarded RFP from CVENT by traversing through multiple pages, consolidating the fetched data details, and saving into excel.</p>
                            <p class="text-muted">It then process each RFP one by one and creates the PR in SmartBuy Ariba. If any business/system error(s) occurred during the process the robot sends an email to an individual/group. At the end of the process a report is generated from the saved excel and robot sends the report to specified & designated users.</p>
            
                            <h5>Source to Pay Automation Benefits:</h5>
